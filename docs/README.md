...
| [`user-guide/core-workflow.md`](user-guide/core-workflow.md) | The everyday loop: project → PM chat → launch an item → gates → deliver |
| [`user-guide/troubleshooting-runs.md`](user-guide/troubleshooting-runs.md) | A run stopped/parked — why, and what to do next |
