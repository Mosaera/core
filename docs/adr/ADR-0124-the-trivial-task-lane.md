...
**Status: ACCEPTED — Approach B shipped 2026-08-29 (`ee61c10e`), default OFF; Approach A deleted.** (Status corrected 2026-09-02; the paragraph below is the decision-time record.) Both are built,
