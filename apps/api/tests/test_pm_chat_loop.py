...
def _turn(
    monkeypatch: pytest.MonkeyPatch, *, tools_on: bool
...
def test_the_default_is_the_single_call_path(monkeypatch: pytest.MonkeyPatch) -> None:
    """Off by default, and off is the branch that existed before — not a loop with one step."""
