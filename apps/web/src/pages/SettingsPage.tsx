...
const SECTIONS: Section[] = [
  ...
  // `read`, deliberately NOT `admin`: every user manages their OWN keys, and the endpoints
  // are session-scoped to the caller. Admin-gating this would contradict the feature —
  // a member could hold a key they had no way to see or revoke (ADR-0127).
  { slug: "api-keys", label: "API keys", need: "read" },
