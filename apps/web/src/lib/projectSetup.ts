...
export const LEG_LABEL: Record<string, string> = {
  tester_vouched: "The Assayer writes the acceptance test",
...
export const PROCTOR_DEPLOYMENT_WIDE =
  "This is a deployment-wide setting: turning the Assayer on turns it on for every project here, " +
  "not just this one.";
...
export function unverifiableWarning(setup: ProjectSetup, draft: SetupDraft): string {
  ...
  return (
    ...
    "you, however good the code is. Turn on the Assayer, or give a test command."
  );
}
