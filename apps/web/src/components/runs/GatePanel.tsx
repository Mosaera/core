...
export function GatePanel({
   ...
   *  Proctor's tests/ scope stays enforced server-side (ADR-0013) — this only spares
  ...
  return (
    ...
    >
      ...
      {gate.amendment_refusals && Object.keys(gate.amendment_refusals).length > 0 ? (
        // F71: the operator authorized an amendment and the Proctor's write was refused. Naming
          ...
          <div className="flex flex-col gap-1.5">
            {outcomes.map((o) => (
              <Button
                ...
                // `amend_tests` promises "the Proctor re-authors X and the run continues" — but the
