...
/** What needs YOU, above everything else (operator cut, 2026-08-13). One row per
 *  actionable fact, one action per row; a quiet single line when nothing does. The
 *  alerts moved here from inside the Health card, where the page's most urgent
 *  information was rendered smallest. */
export function AttentionStrip({ project, mrState }: { project: Project; mrState: string | null }) {
