...
/** "autonomy_profile" → "Autonomy". Derived rather than mapped: the server owns the profile
 *  set (ADR-0122), and a hand-kept label map here would silently miss a fifth profile. */
          ...
          <div className="flex items-center gap-1">
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                onChange(spec.widget === "number" ? Number(raw) : raw);
              }}
