  ...
  return (
    ...
    >
      ...
      <ConfirmDialog
        ...
        title="Disconnect this project from GitHub?"
      ...
      >
        <p>
          Forgets which installation delivery resolved for this project. Delivery re-resolves it
          from GitHub on the next attempt — this does not revoke the App&rsquo;s access; do that
          on GitHub if that is what you want.
        </p>
      </ConfirmDialog>
    </SettingsSection>
  );
