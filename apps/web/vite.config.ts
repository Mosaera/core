...
export default defineConfig({
  ...
  test: {
    ...
    // Playwright specs under e2e/ run via `npm run e2e`, never under vitest — vitest importing
    // @playwright/test throws "did not expect test.beforeAll() to be called here".
